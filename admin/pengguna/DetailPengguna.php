...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bolder text-center"><b>Detail Pengguna</b></h2>
        <hr>
                ...
                <dl class="row">
                    ...
                    <div class="d-flex w-100 justify-content-end">
                        <div class="col-auto me-2">
                            <a href=".?page=pengguna/FormPengguna&id=<?= isset($id) ? $id : '' ?>" class="btn btn-primary bg-gradient btn-sm rounded-0 d-flex align-items-center"><span class="material-icons">edit</span> Edit</a>
                        </div>
                        <div class="col-auto">
...
<script>
    $(function(){
        $('#delete_data').click(function(){
            _conf("Apakah Yakin Ingin Menghapus Pengguna?","hapus_pengguna",['<?= isset($id) ? $id : '' ?>'])
        })
    })
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.status == 'success') {
                    location.replace('./?page=pengguna')
                } else if (!!resp.msg) {
                    el.text('An error occurred.')
                    el.show('slow')
                } else {
