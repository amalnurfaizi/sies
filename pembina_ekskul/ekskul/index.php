<section class="py-4">
    <div class="container">
        <h3 class="fw-bolder text-center">Ekskul Yang Di Kelola</h3>
        <center>
...
<script>
    $(function(){
        $('.dt-init').DataTable({
            ...
            searching: false,
            ajax: {
                url:"../classes/Master.php?f=ekskul_yang_dikelola",
                method:"POST"
            },
            columns: [{
                    data: 'no',
            ...
            drawCallback: function(settings) {
                ...
                $('.delete_data').click(function(){
                    _conf("Apakah Kamu Yakin Ingin Menghapus  <b>"+$(this).attr('data-name')+"</b> from list?","delete_club",[$(this).attr('data-id')])
                })
            },
            language:{
                oPaginate: false
