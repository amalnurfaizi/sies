...
<section class="py-4">
    <div class="container">
        <h3 class="fw-bolder text-center">Daftar Ketua</h3>
        <center>
...
<script>
    $(function(){
        $('.dt-init').DataTable({
            ...
            searching: false,
            ajax: {
                url:"../classes/Master.php?f=data_ketua",
                method:"POST"
            },
            columns: [{
                    data: 'no',
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        el.find('.edit_data').attr("href","./?page=ketua/FormKetua&id="+row.id)
                        el.find('.view_data').attr("href","./?page=ketua/DetailKetua&id="+row.id)
            ...
            drawCallback: function(settings) {
                ...
                $('.delete_data').click(function(){
                    _conf("Apakah Yakin Menghapus ketua Dengan Nama <b>"+$(this).attr('data-name')+"</b> Dari list?","hapus_ketua",[$(this).attr('data-id')])
                })
                $('.reset_pass').click(function(){
                    _conf("Apakah Yakin Ingin Mereset Password <b>"+$(this).attr('data-name')+"'s</b>?","reset_pass",[$(this).attr('data-id')])
                })
            },
            language:{
                oPaginate: false,
