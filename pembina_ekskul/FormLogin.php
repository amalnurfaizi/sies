...
<body class="index-page bg-gray-200">
    ...
    <div class="row justify-content-center mx-0">
        <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
            <div class="card card-body shadow-blur mx-3 mx-md-4 rounded-0">
                ...
                <?php endif; ?>
                <div class="container">
                    <h4 class="fw-bolder text-center">Login Sebagai Pembina</h4>
                    <hr>
                    <br>
                    <form action="" id="pembina-login-form">
	...
	if (x.type === 'password') {
        ...
        $(function(){
            $('#pembina-login-form').submit(function(e){
                e.preventDefault()
                $('.pop-alert').remove()
                var _this = $(this)
                var el = $('<div>')
                ...
                start_loader()
                $.ajax({
                    url:'../classes/Login.php?f=pembina',
